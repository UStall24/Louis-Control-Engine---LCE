...
# Ueberarbeitung der Kommunikation ueer http.server                                   // 12.04.2025       // Johann Spielvogel
...
#####################################################
#---PH-Wert Sensor; MCP3008-------------------------#
#####################################################
import gpiozero
# ---MCP3008 Setup (hier Kanal 0 für pH-Sensor)
...
def on_message(client, userdata, message):
    ...
    #Pumpe
    if direction == 'Pumpe_einschalten':
    ...
    if direction == 'Start_PH_Messung':
        ...
        client.publish("Ustall/PH_Wert", f"{ph_wert:.2f}")  # für Webinterface
